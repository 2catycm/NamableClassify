...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_nucleus (classification core api).ipynb.

# %% auto 0
__all__ = ['ClassificationModelConfig', 'HuggingfaceModel', 'ClassificationTaskConfig', 'ClassificationTask']

# %% ../nbs/01_nucleus (classification core api).ipynb 5
import os
os.environ['HF_ENDPOINT'] = "https://hf-mirror.com" # TODO this is optional for Foreigners

# %% ../nbs/01_nucleus (classification core api).ipynb 7
...
# %% ../nbs/01_nucleus (classification core api).ipynb 8
...
# %% ../nbs/01_nucleus (classification core api).ipynb 9
@patch
