...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../src/notebooks/01_nucleus (classification core api).ipynb.

# %% auto 0
__all__ = ['ClassificationModelConfig', 'HuggingfaceModel', 'ClassificationTaskConfig', 'ClassificationTask']

# %% ../src/notebooks/01_nucleus (classification core api).ipynb 5
import os
os.environ['HF_ENDPOINT'] = "https://hf-mirror.com" # TODO this is optional for Foreigners

# %% ../src/notebooks/01_nucleus (classification core api).ipynb 7
...
# %% ../src/notebooks/01_nucleus (classification core api).ipynb 8
...
# %% ../src/notebooks/01_nucleus (classification core api).ipynb 9
@patch
...
# %% ../src/notebooks/01_nucleus (classification core api).ipynb 10
from lightning.pytorch import loggers as pl_loggers
from .help import runs_path

# %% ../src/notebooks/01_nucleus (classification core api).ipynb 12
import lightning as L
