...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../src/notebooks/04auto/exp_fullfinetune.ipynb.

# %% auto 0
__all__ = ['start', 'end', 'learning_rates', 'seed', 'run_names', 'learning_rate_exec']

# %% ../../../src/notebooks/04auto/exp_fullfinetune.ipynb 4
from ..experiment import fixed_meta_parameters, run_with_config

# %% ../../../src/notebooks/04auto/exp_fullfinetune.ipynb 5
# 先直接跑两个, 来不及写了
...
# %% ../../../src/notebooks/04auto/exp_fullfinetune.ipynb 7
# seed = 0
seed = 2
# seed = 1
...
# %% ../../../src/notebooks/04auto/exp_fullfinetune.ipynb 8
run_names = [f"{lr:.2e}" for lr in learning_rates]

# %% ../../../src/notebooks/04auto/exp_fullfinetune.ipynb 10
#| eval: false
