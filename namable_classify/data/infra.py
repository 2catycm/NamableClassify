...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02data/infra.ipynb.

# %% auto 0
__all__ = ['simple_pixel_flatten_transform', 'cls_names_of', 'ClassificationDataConfig', 'dataloader_to_arrays',
           'ClassificationDataModule', 'sksplit_for_torch', 'TorchVisionDataModule', 'CIFAR100DataModule',
           'MNISTDataModule', 'CIFAR10DataModule', 'FashionMNISTDataModule', 'QMNISTDataModule', 'KMNISTTDataModule']

# %% ../../nbs/02data/infra.ipynb 5
from pathlib import Path
from ..help import data_path

# %% ../../nbs/02data/infra.ipynb 6
