...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_main (example running script).ipynb.

# %% auto 0
__all__ = ['config', 'cls_task', 'trainer', 'tuner', 'lr_finder', 'fig', 'new_lr']

# %% ../nbs/05_main (example running script).ipynb 5
...
# %% ../nbs/05_main (example running script).ipynb 6
...
# %% ../nbs/05_main (example running script).ipynb 9
#| eval: false
...
# %% ../nbs/05_main (example running script).ipynb 11
#| eval: false
trainer.fit(cls_task, datamodule=cls_task.lit_data)

# %% ../nbs/05_main (example running script).ipynb 12
#| eval: false
